...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2017 at 04:30 AM
...
-- Database: `lunix`
--
CREATE DATABASE IF NOT EXISTS `lurc`;
USE `lurc`;
-- --------------------------------------------------------
...
CREATE TABLE `accounts` (
  ...
  `admin_level` int(11) NOT NULL DEFAULT '0' COMMENT '0 = User, 1 = Admin, 2 = Super admin'
...
--
ALTER TABLE `instances`
  MODIFY `instanceid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `sessions`
  MODIFY `sessionid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
